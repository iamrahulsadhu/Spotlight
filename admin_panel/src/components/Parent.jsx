    ...
    <>
      <div className="col-2 side-nav"> 
        <div className="container-fluid nav-div">
          ...
          <div className="">
            <ul className="row">
            <Link to="/admin" className="linkStyle"><li className="nav-items col-12">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                  fill="currentColor"
                  className="bi bi-terminal-dash ms-2"
                  viewBox="0 0 16 16"
                >
              ...
              <Link to="/admin/table" className="linkStyle"><li className="nav-items col-12">
                <svg 
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                  fill="currentColor"
                  className="bi bi-file-earmark-spreadsheet ms-2"
                  viewBox="0 0 16 16"
                >
             ...
             <span className="ms-3">Insert</span>
              </li></Link>
              <Link to="/admin/update" className="linkStyle"><li className="nav-items col-12">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                  fill="currentColor"
                  className="bi bi-app-indicator ms-2"
                  viewBox="0 0 16 16"
                >
